...
import com.mpp.stellaeomphalos.content.entity.p6.LucentSparkEntity;
import com.mpp.stellaeomphalos.content.item.BlockPalette;
import com.mpp.stellaeomphalos.content.item.PartSixItems;
import com.mpp.stellaeomphalos.content.item.PartSixRodItems;
...
/** Part-6 §6.2.2 物品注册总账与 §6.4.4 / §6.6.2 运行期验收。 */
@GameTestHolder(Omphalos.MODID)
@PrefixGameTestTemplate(false)
public final class PartSixItemsGameTests {
    ...
    public static void builder_rod_simulates_then_commits_the_material(GameTestHelper helper) {
        ...
        var rod = new ItemStack(PartSixItems.BUILDER_ROD.get());
        ...
        var candidates =
                List.of(
                        ...
                        base.above());
        var plan =
                com.mpp.stellaeomphalos.content.item.PartSixRodItems.plan(
                        level,
                        player,
                        candidates,
                        states,
                        com.mpp.stellaeomphalos.content.item.PartSixRodItems.REPLACEABLE_ONLY,
                        com.mpp.stellaeomphalos.content.item.PartSixRodItems.BuilderRodItem
                                .MAX_PLACEMENT);
        helper.assertTrue(
                plan.size() == 2,
        ...
        int placed =
                com.mpp.stellaeomphalos.content.item.PartSixRodItems.commit(level, player, plan);
        ...
        helper.assertTrue(
                com.mpp.stellaeomphalos.content.item.PartSixRodItems.plan(
                                ...
                                candidates,
                                states,
                                com.mpp.stellaeomphalos.content.item.PartSixRodItems
                                        .REPLACEABLE_ONLY,
                                20)
                        .isEmpty(),
    ...
    public static void amulet_applies_without_an_explicit_context(GameTestHelper helper) {
        ...
        var amulet = new ItemStack(PartSixItems.WARDED_AMULET.get());
    ...
    public static void drops_are_replaced_by_the_specialised_item_entities(GameTestHelper helper) {
        ...
        helper.assertTrue(
                com.mpp.stellaeomphalos.content.item.ItemEntityReplacement.replacementFor(
                                new ItemStack(PartSixItems.SKY_CRYSTAL.get()))
                        == com.mpp.stellaeomphalos.content.entity.p6.PartSixEntities.GEODE_ENTITY
                                .get(),
                "A sky crystal drop must become a geode entity");
        helper.assertTrue(
                com.mpp.stellaeomphalos.content.item.ItemEntityReplacement.replacementFor(
                                new ItemStack(PartSixItems.CHARGED_GEODE_PICKAXE.get()))
                        == com.mpp.stellaeomphalos.content.entity.p6.PartSixEntities
                                .GEODE_TOOL_ENTITY
                                .get(),
        ...
        helper.assertTrue(
                com.mpp.stellaeomphalos.content.item.ItemEntityReplacement.replacementFor(
                        ...
                        == com.mpp.stellaeomphalos.content.entity.p6.PartSixEntities.STAR_DUST
                                .get(),
        ...
        var geodeItem = PartSixItems.SKY_CRYSTAL.get();
        ...
        var replaced =
                helper.getLevel().getEntitiesOfClass(
                        com.mpp.stellaeomphalos.content.entity.p6.GeodeEntity.class,
    ...
    public static void runed_wand_aevitas_paves_phase_barriers(GameTestHelper helper) {
        ...
        player.setPos(anchor.getX() + 0.5D, anchor.getY(), anchor.getZ() + 0.5D);
        var stack = new ItemStack(PartSixItems.RUNED_WAND.get());
        PartSixRodItems.setAugment(stack, PartSixRodItems.WandAugment.AEVITAS);
    ...
    public static void runed_wand_vicio_release_applies_the_charge_impulse(GameTestHelper helper) {
        ...
        player.setYRot(0.0F);
        var stack = new ItemStack(PartSixItems.RUNED_WAND.get());
        PartSixRodItems.setAugment(stack, PartSixRodItems.WandAugment.VICIO);
        var item = (PartSixRodItems.RunedWandItem) stack.getItem();
        ...
        item.releaseUsing(
                ...
                helper.getLevel(),
                player,
                item.getUseDuration(stack) - PartSixRodItems.RunedWandItem.CHARGE_TICKS);
        var motion = player.getDeltaMovement();
        helper.assertTrue(motion.lengthSqr() > 0.0D, "A full charge must produce an impulse");
        helper.assertTrue(
                motion.y
                        >= PartSixRodItems.RunedWandItem.CHARGE_Y_FLOOR
                                        * PartSixRodItems.RunedWandItem.CHARGE_SCALE
                                - 1.0E-6D,
    ...
    public static void star_glass_engraving_is_capped_and_persistent(GameTestHelper helper) {
        var stack = new ItemStack(PartSixItems.STAR_GLASS.get());
    ...
    public static void warded_amulet_rolls_exactly_once(GameTestHelper helper) {
        var stack = new ItemStack(PartSixItems.WARDED_AMULET.get());
        helper.assertTrue(
        ...
        var rolled =
                com.mpp.stellaeomphalos.content.item.amulet.AmuletHolder.rollIfNeeded(
                        ...
                        PartSixItems.candidateEnchantments(),
                        id -> 0,
        ...
        helper.assertTrue(
                !com.mpp.stellaeomphalos.content.item.amulet.AmuletHolder.rollIfNeeded(
                        stack, helper.getLevel().random, PartSixItems.candidateEnchantments(), id -> 0, null),
