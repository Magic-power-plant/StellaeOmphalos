...
public final class PartSevenClientSmoke {
    ...
    public static void tick(Minecraft mc) {
                                ...
                                var states =
                                        java.util.List.of(
                                                ...
                                                CraftingContent.GRINDWHEEL
                                                        .get()
                                                        .defaultBlockState(),
                                                PartSixBlocks.STAR_CHART_TABLE
                                                        .get()
                                                        .defaultBlockState(),
                                                PartSixBlocks.RESONANCE_ALTAR
                                                        .get()
                                                        .defaultBlockState(),
                                                PartSixBlocks.BEAM_LENS.get().defaultBlockState(),
                                                PartSixBlocks.BEAM_PRISM.get().defaultBlockState(),
                                                WorldContent.BLOCKS
                                                        .get("observatory")
                                                        .get()
                                                        .defaultBlockState(),
                                                PartSixBlocks.SPYGLASS.get().defaultBlockState(),
                                                WorldContent.BLOCKS
                                                        .get("gate_core")
                                                        .get()
                                                        .defaultBlockState());
        ...
        if (ticks == 60) {
            ...
            if (!mc.getItemRenderer()
                    .getModel(
                            new net.minecraft.world.item.ItemStack(
                                    com.mpp.stellaeomphalos.content.item.PartSixItems.HAND_SPYGLASS
                                            .get()),
                            mc.level,
                            mc.player,
                            0)
