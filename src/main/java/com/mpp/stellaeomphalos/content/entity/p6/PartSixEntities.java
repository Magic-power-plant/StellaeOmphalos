...
/**
 * Part-6 实体注册目录：14 个实体类型的声明与 attach。
 *
 ...
 * 一律不注册 spawn egg。
 */
public final class PartSixEntities {
    ...
    public static void attach(IEventBus bus) {
        PartSixEntities.class.getName();
        bus.addListener(PartSixEntities::attributes);
    }
