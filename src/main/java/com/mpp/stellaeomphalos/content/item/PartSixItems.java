...
import com.mpp.stellaeomphalos.content.item.PartSixRodItems.BuilderRodItem;
import com.mpp.stellaeomphalos.content.item.PartSixRodItems.GrapnelRodItem;
import com.mpp.stellaeomphalos.content.item.PartSixRodItems.HandSpyglassItem;
import com.mpp.stellaeomphalos.content.item.PartSixRodItems.IlluminationDustItem;
import com.mpp.stellaeomphalos.content.item.PartSixRodItems.LuminaryRodItem;
import com.mpp.stellaeomphalos.content.item.PartSixRodItems.NocturnalDustItem;
import com.mpp.stellaeomphalos.content.item.PartSixRodItems.ResonanceLinkerItem;
import com.mpp.stellaeomphalos.content.item.PartSixRodItems.RosewoodBowItem;
import com.mpp.stellaeomphalos.content.item.PartSixRodItems.RunedWandItem;
import com.mpp.stellaeomphalos.content.item.PartSixRodItems.SwapperRodItem;
...
public final class PartSixItems {
    ...
    public static final class SignChartItem extends Item {
        ...
        public net.minecraft.world.InteractionResultHolder<ItemStack> use(
            ...
            // 客户端播翻书音并打开星象详情（界面归 Part-7）；服务端无副作用。
    ...
    public static void registerDispenserBehaviours() {
                            ...
                            level.getBlockState(source.getPos())
                                    .getValue(
                                            net.minecraft.world.level.block.DispenserBlock
                                                    .FACING);
                    if (!com.mpp.stellaeomphalos.content.entity.p6.LucentSparkEntity.placeLightAt(
        ...
        net.minecraft.core.dispenser.DispenseItemBehavior umbral =
                (source, stack) -> {
                    ...
                    var spark =
                            new com.mpp.stellaeomphalos.content.entity.p6.UmbralSparkEntity(
